...
sim_l = pd.read_csv('m_kernel_normalized.csv', header=None, index_col=None).values
sim_d =  pd.read_csv('d_kernel_normalized.csv', header=None, index_col=None).values
...
np.savetxt('VGAE_microbe_feature.csv', feature_l, delimiter=',')
np.savetxt('VGAE_disease_feature.csv', feature_d, delimiter=',')